...
<details>
  <summary> Session 4: Load layers with PyQGIS from shapefile and from csv file. Create and update QGIS project. </summary>

  - Load layers with PyQGIS from shapefile and from csv file.
  - Create and update QGIS project.
