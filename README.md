...
<details markdown="block">
  ...
  - T25: Consider the problem of deriving the location of solar panels from Sentinel-2 10 m imagery; Create script to implement the sequence of steps in [this diagram](diagram_exercise_alcoutim.pdf).
